...
<body class="grey lighten-2" id="body" style="height: 100.06vh;">
    ...
    <div id="login" class="modal">
        ...
        <div class="modal-footer">
            <a href="javascript:void(0);" onclick="login();" class="modal-action waves-effect waves-light btn-flat">Anmelden<i
        ...
        <ul id="createPost" class="collapsible" data-collapsible="accordion" permission="PERMISSION_ADD_POST">
            <li>
                ...
                <div class="collapsible-body white">
                    <form id="createform" action="javascript:void(0);" onsubmit="createPost();" class="row"
                          style="margin:0px;">
        ...
        <script type="application/javascript">
            ...
            function createPost() {
                ...
                $.post('', {
                    'console': '',
                    'action': 'addPost',
                    'auth_token': Cookies.getJSON('auth').token,
                    'subject': title,
                    'body': text,
                    'releaseDate': toMYSQLDate(new Date())
                }, function (data) {
                    if (data.code == 200) {
