...
<div class="container">
    ...
    <div class="card">
        <div class="card-content ">
			...
			<input type="submit" value="Neue Sprechzeit eintragen" class="btn-flat btn-large waves-effect waves-light teal-text col s12"></input>
			</form>
			</div>
            <?php
            if (isset($data["slots"])) { ?>
                ...
                <?php
					foreach ($data["slots"] as $s) { ?>
						...
						<a id="slot" href="?type=setslots&del=<?php echo $s['id']; ?> "class="teal-text"><i class="material-icons">delete</i></a>
							</ul>
                <?php
                } ?>
				</div>
