...
?>
    ...
    <li><a id="est" <?php if($est){ echo 'href="?type=eest"'; } ?> title="Home" class="<?php echo $color[$est]; ?>"><i class="material-icons left">supervisor_account</i>Elternsprechtag</a></li>
    <li><a id="vplan" <?php if($vplan){ echo 'href="?type=vplan"'; } ?> title="Home" class="<?php echo $color[$vplan]; ?>"><i class="material-icons left">dashboard</i>Vertretungsplan</a></li>
	  <li><a id="events" <?php if($events){ echo 'href="?type=events"'; } ?> title="Home" class="<?php echo $color[$events]; ?>"><i class="material-icons left">today</i>Termine</a></li>
	  <li><a id="news" <?php if($news){ echo 'href="?type=news"'; } ?> title="Home" class="<?php echo $color[$news]; ?>"><i class="material-icons left">library_books</i>Newsletter</a></li>
