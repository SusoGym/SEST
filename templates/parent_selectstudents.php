          ...
          <span class="card-title">Hier können Sie Ihre Kinder auswählen: </span>
            <div class="container">
              <form action="?type=addstudent" class="row" method="post">
                ...
                <a onclick="form.submit();" class="col s12  btn-large center modal-action waves-effect waves-teal btn-flat">Eingetragene Schüler hinzufügen <i class="material-icons right large">send</i></a>
              </form>
            </div>
        </div>
